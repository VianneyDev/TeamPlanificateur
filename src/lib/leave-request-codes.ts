export const WEEKEND_NOT_ALLOWED_CODE = "WEEKEND_NOT_ALLOWED";
export const WEEKEND_NOT_ALLOWED_ERROR =
  "Leave Requests cannot include weekend dates";
...
export const DAY_OFF_CREATE_FORBIDDEN_ERROR =
  "Non-managers cannot create Day Offs directly; submit a Leave Request";
